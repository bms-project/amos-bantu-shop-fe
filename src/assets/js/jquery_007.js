...
!function (t) {
  ...
  t.fn.bxSlider = function (n) {
    ...
    var a = t(window).width(), l = t(window).height(), d = function () {
      ...
      var t = 1;
      if ("horizontal" == o.settings.mode && o.settings.slideWidth > 0) if (o.viewport.width() < o.minThreshold) t = o.settings.minSlides; else if (o.viewport.width() > o.maxThreshold) t = o.settings.maxSlides; else if (typeof o.viewport[0].firstChild.className != 'undefined' && o.viewport[0].firstChild.className == 'cust-viewed-slider') t = o.settings.maxSlides; else {
